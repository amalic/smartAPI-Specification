...
Field Name | Type | Description
---|:---:|---
<a name="infoDescription"></a>description | `string` | **SHOULD** See See <a href="https://github.com/WebsmartAPI/OpenAPI-Specification/blob/OpenAPI.next/versions/3.0.md#fixed-fields-1">above</a>. 
...
<a name="infoPublications"></a>x-publications | `URI` | Publications that describe the API.
<a name="infoFunding"></a>x-funding | `string` | Indicate sources of funding.
