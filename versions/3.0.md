...
Field Name | Type | Description
---|:---:|---
<a name="infoResponsibleOrganization"></a>responsibleOrganization | `string` | **REQUIRED** Provide the name of the organization responsible for the service.
<a name="infoResponsibleDeveloper"></a>responsibleDeveloper | `URI` | **REQUIRED** Provide the name, ID and email for the responsible developer.
<a name="infoContributor"></a>Contributor | `string` | Indicate any other contributor to the conception, development, or support of the API.
...
Field Name | Type | Description
---|:---:|---
<a name="serverUrl"></a>location | `uri` | Location, city and country of the server hosting the API.
...
Field Name | Type | Description
---|:---:|---
<a name="responseMimeType"></a>responseMimeType | `string` | **REQUIRED**. A list of media types the APIs can produce. The media type definitions should be in compliance with <a href="http://tools.ietf.org/html/rfc6838">RFC6838</a>.
